    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo and Info */}
          <div>
            <h2 className="text-xl font-bold mb-4">Coin_Control</h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {/* <li><a href="#" className="  className="text-gray-400 hover:text-white">Blog</a></li> */}
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Coin_control_Company
          </p>
          <div className="flex space-x-4">
            <a href="#" className="text-gray-400 hover:text-white text-sm">Privacy & Terms</a>
